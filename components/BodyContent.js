...
export const BodyContent = () => {
  ...
  return (
    <div className={styles.divColum}>
        ...
        <div className={`${styles.hiddenBodyResumeSkills} ${contentSkills ? styles.divBodyResumeSkills : ''}`}>
          {contentSkills && (
          <>
            <div className={`${styles.hiddenBodyResumeSkillsRow} ${contentSkills ? styles.divBodyResumeSkillsRow : ''}`}>
        ...
        <div className={`${styles.hiddenBodyCareer} ${contentAcademic ? styles.divBodyCareer : ''}`}>
          {contentAcademic && (
            <>
